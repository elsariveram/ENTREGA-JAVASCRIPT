...
//     event.preventDefault();
                ...
                function SolicitarDatosUsuario() {
                    ...
                    while (true) {
                        try {
                            VarNombre = document.getElementById('name').value;
                            if (!VarNombre) {
                            throw new Error('Por favor, ingresa tu nombre antes de continuar');
                            }
                            // Código para procesar el formulario si el nombre está presente
                            Swal.fire({
                            icon: 'success',
                            title: 'Ingresando',
                            text: 'Estás ingresando'
                            });
                        } catch (error) {
                            Swal.fire({
                            icon: 'warning',
                            ...
                            icon: 'info',
                            title: 'Información',
                            text: 'Validación de formulario completada'
                            });
                        }
